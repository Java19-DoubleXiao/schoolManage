...
public class LeaveProcessTrackVo implements Serializable{
	...
	public String toString() {
		return "LeaveProcessTrackVo [trackId=" + trackId + ", leaveId=" + leaveId + ", nodeId=" + nodeId + ", handler="
				+ handler + ", suggestion=" + suggestion + ", dealTime=" + dealTime + ", dealResult=" + dealResult
				+ ", node=" + node + ", teaName=" + teaName + ", teaType=" + teaType + "]";
	}
